...
Cuando realizamos un análisis datos es necesario el calculo de indicadores que faciliten su interpretación. Para el caso de las variables cualitativas se utiliza como indicador de resument la moda. Los siguientes indicadores corresponde a variables cuantitativas. 
...
La siguiente información corresponde a las notas obtenidas en una prueba competencias cumputacionales realizada a un grupo de aspirantes a ingresar a una maestria.

Construya un gráfico y los indicadores que le permitan caracterizar los datos
Que porcentaje de los estudiantes reprobaron la evaluación? ($nf < 3.0$)
...
Continuando con la data `iris` , los investigadores requieren visualizar si existen diferencias en cuanto al longitus  de los sepalos al comparar las tres especies que contiene la data
