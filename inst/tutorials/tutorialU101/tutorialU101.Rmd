...
Crea un data.frame que además del identificador (ID) contenga la edad en añoñs de la persona.  Utiliza la función `rnorm()` para simular valores  a partir de una distribución normal con media 25 años y desviación 5 años (aproximando el valor a números enteros)
...
Ahora adiciona una variable que represente la valoración del servicio prestado en un servicio de transporte (Excelente, Muy bueno, Bueno, Regular, Muy Regular), teniendo en cuenta que la distribución de estos resultados es : 0.28,0.50, 0.15, 0.05, 0.02). Utilice para ello la función `sample()`
