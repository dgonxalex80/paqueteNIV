...
* **variable aleatoria** : función que asigna a cada elemento de un espacio muestral asociado a un experimento aleatorio un número

* **variable aleatoria discreta** : variable cuyo conjunto de valores posibles (rango) es un conjunto finito o infinito numerable

* **variable aleatoria continua** : variable cuyo conjunto de valores posibles es un conjunto infinito de valores no numerables

* **función de distribución de probabilidad** : función que asigna a cada valor de una variable aleatoria discreta un valor de probabilidad. $f(x)\geq 0$ y $\sum_{R_{X}} f(x) =1$

* **función de densidad de probabilidad** : función que asigna a cada valor de la variable aletoria contunua un valor- $f(x)\geq0$ y $\int f(x) =1$

* **función de probabilidad acumulada** : $F(x) = P(X \leq x)$

* **valor esperado** : $E[X]$ media poblacional

* **varianza** : $V[X]$ varianza poblacional
