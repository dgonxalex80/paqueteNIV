...
quiz(  
  question("Sea P(A) = 0.50 y P(B) = 0.30, donde A y B son eventos independientes. Entonces se puede afirmar que: ", allow_retry = TRUE,
    ...
    answer("P(A ∪ B)= 0.50", message = "Nop...intentalo de nuevo!"),
...
quiz(  
  question("Sea P(A) = 0.50 y P(B) = 0.30 y P(A ∩ B) = 0.20, podemos afirmar que", allow_retry = TRUE,
    ...
    answer("A ∩ B = S", message = "Nop...intentalo de nuevo!"),
    # Si no cambiamos estos textos en los botones, se mostrarán en Inglés  
    submit_button = "Enviar respuesta",
    correct = "Correcto!",
    incorrect = "Incorrecto!",
...
quiz(  
  ...
  allow_retry = TRUE,
    answer("P(A ∩ C) = (190 + 12)/332", message = "Incorrecto. Intenta de nuevo!."),
    answer("P(A ∩ B) = (190+120)/810", message = "No, pero no...intentalo de nuevo!"),
    answer("P(H ∩ B) = 332/810", correct = TRUE),
    answer("P(M | B) = 60/440", message = "Nop...intentalo de nuevo!"),
    # Si no cambiamos estos textos en los botones, se mostrarán en Inglés  
    submit_button = "Enviar respuesta",
    correct = "Correcto!",
    incorrect = "Incorrecto!",
...
quiz(  
  ...
  allow_retry = TRUE,
    ...
    answer("0 ≤ P(A) ≤ 1", message = "Nop...intentalo de nuevo!"),
    # Si no cambiamos estos textos en los botones, se mostrarán en Inglés  
    submit_button = "Enviar respuesta",
    correct = "Correcto!",
    incorrect = "Incorrecto!",
